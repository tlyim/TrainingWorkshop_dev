...
def _(mo):
    ...
    <img src="img/Vectorized_computation_visualization.png" alt="Vectorized computation visualization" width="600"/>
    <!-- This Markdown syntax does not work on GitHub Codespaces
    ![Vectorized computation visualization](img/Vectorized_computation_visualization.png){width=600px}
     -->
...
def _(mo):
    ...
    - Open the marimo notebook `Wk04w_Dashboard.py` to see the demo code for a dashboard app
    """)
    return
...
def _(mo):
    ...
    - To deploy various elements covered in this marimo notebook as a **dashboard app**,
        ...
        ```bash
            marimo run TrainingWorkshop.py --sandbox --include-code
        ```
...
def _(mo):
    ...
    - Open the marimo notebook `Wk04x_MyPortfolio.py` to see the demo code for a **multi-tabbed webpage**
    ...
    - To **create a new gist** to store your data secretly,
        ...
        - Next, go back to the `Gist` page and click on the large box in the center of the page
            ...
            - go to the notebook `Wk04x_MyPortfolio.py` and look at the second code cells to see **how to load data remotely** from the raw gist URL
...
def _(mo):
    ...
    Since we are using tools in the GitHub ecosystem, you can turn the notebook `Wk04x_MyPortfolio.py` with the code for a multi-tabbed webpage into a real website in 3 steps:
